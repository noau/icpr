...
public interface AssignmentService {
    ...
    Integer addAssignment(String course_id, String title, String description,
    ...
    void reviewsAssignment(Integer submissionId, Float grade, String feedback, String gradeAt);
