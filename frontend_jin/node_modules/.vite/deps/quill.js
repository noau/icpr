    ...
    !function(t, e) {
      ...
      return function() {
        var t = { 9698: function(t2, e2, n2) {
          ...
          __publicField(_I, "version", "2.0.2");
...
${(0, l.X)(this.code(t3, e3))}
          ...
          const q = (0, l.A)("quill:clipboard"), k = [[Node.TEXT_NODE, function(t3, e3, n3) {
            ...
            if (!R(t3)) {
              ...
              r3 = r3.replace(/\r\n/g, " ").replace(/\n/g, " "), r3 = r3.replace(/\s\s+/g, i2.bind(i2, true)), (null == t3.previousSibling && null != t3.parentElement && j(t3.parentElement, n3) || t3.previousSibling instanceof Element && j(t3.previousSibling, n3)) && (r3 = r3.replace(/^\s+/, i2.bind(i2, false))), (null == t3.nextSibling && null != t3.parentElement && j(t3.parentElement, n3) || t3.nextSibling instanceof Element && j(t3.nextSibling, n3)) && (r3 = r3.replace(/\s+$/, i2.bind(i2, false)));
            }
            return e3.insert(r3);
