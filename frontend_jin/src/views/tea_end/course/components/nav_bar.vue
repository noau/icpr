<template>
  ...
  >
    <el-sub-menu index="1">
      ...
      <el-menu-item :class="{ active: currentIndex === '1-5' }" index="1-5">学生名单</el-menu-item>
    </el-sub-menu>
...
const handleSelect = (key) => {
  ...
  switch (key) {
    case '1-1':
      router.push('/tea-end/course/base/course-introduction')
      break
    case '1-2':
      router.push('/tea-end/course/base/teaching-outline')
      break
    case '1-3':
      router.push('/tea-end/course/base/teaching-calendar')
      break
    // case '1-4':
    //   router.push('/tea-end/course/base/teacher-info')
    //   break
    case '1-5':
      router.push('/tea-end/course/base/student-list')
      break
    case '2-1':
      router.push('/tea-end/course/resource/slides')
      break
    case '2-2':
      router.push('/tea-end/course/resource/old-exam')
      break
    case '2-3':
      router.push('/tea-end/course/resource/exercise')
      break
    case '3-1':
      router.push('/tea-end/course/examine/homework')
      break
    case '4':
      router.push('/tea-end/course/discussion')
      break  
  }
}
</script>
