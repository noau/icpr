          ...
          <div>
            <div class="perInfoTop flex flex-align-center">
              ...
              <div style="margin-top: 20px" class="flex">
                ...
                <el-button @click="subscription">关注</el-button>
              </div>
            </div>
            ...
            <div class="bottomCon">
              <div class="blockBt">
                ...
                <div v-for="item in collectList" :key="item.id" class="flagBlocktag">
                  <!-- collectList -->
                  <div v-if="!item.isPrivate" class="blocktag">
...
const toThread = (item) => {
  router.push(`/tea-end/course/discussion/post/${item.threadId}`);
}
// 获取收藏夹
