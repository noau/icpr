...
const tableData = ref([
  { name: '习题1.pdf', url: 'https://example.com/file1.pdf', allowDownload: true, published: true },
  { name: '习题2.pdf', url: 'https://example.com/file2.pdf', allowDownload: true, published: true },
  // ... 其他数据 ...
]);
