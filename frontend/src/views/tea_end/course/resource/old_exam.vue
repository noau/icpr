<template v-slot:header>
  <el-row :gutter="20" class="header" style="margin-top: 0px; margin-left: 10px; margin-right: 10px;">
...
import { getexam, resourceexam } from '@/api/course'
